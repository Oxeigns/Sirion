...
from OxygenMusic import userbot
...
playtype = {}
skipmode = {}
user_play_count: Dict[int, int] = {}
chat_play_count: Dict[int, int] = {}
...
def get_top_users(limit: int = 5):
    return sorted(user_play_count.items(), key=lambda x: x[1], reverse=True)[:limit]
